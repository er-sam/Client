...
// function FooterPage() {
//   return (
//     <div classNameName="bottom-3 sm:bottom-3 mt-6">
//       <footer className="bg-slate-200 mt-7">
...
function FooterPage() {
  return (
    <Footer className="bg-gray-800 rounded-none" container>
      <div className="w-full text-center">
        ...
        <Footer.Divider />
        <Footer.Copyright href="#" by="Q-Shop™" year={2022} />
      </div>
    </Footer>
  );
}
